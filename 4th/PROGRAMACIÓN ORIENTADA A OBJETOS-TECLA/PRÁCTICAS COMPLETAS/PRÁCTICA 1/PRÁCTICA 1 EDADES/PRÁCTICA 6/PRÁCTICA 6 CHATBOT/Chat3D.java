...
public class Chat3D extends Frame {
  ...
  public Chat3D() {
    ...
    bconfun=new Button("Confundido");
    bconfun.addActionListener(eh);
    bconten=new Button("Contento");
    bconten.addActionListener(eh);
    baburr=new Button("Aburrido");
    baburr.addActionListener(eh);

    p=new Panel();
    p.add(bfeliz); p.add(benfer);p.add(bconfun);p.add(bconten);p.add(baburr);
  ...
  class EventHandler extends WindowAdapter implements ActionListener {  
    ...
    public void actionPerformed(ActionEvent e) {  
      ...
      if(btn==bconfun){
        b.changeTextureCab(texture, "caraconfundido.jpg");
      }
      if(btn==bconten){
        b.changeTextureCab(texture, "caracontento.jpg");
      }
      if(btn==baburr){
        b.changeTextureCab(texture, "caraaburrido.jpg");
      }
    }
